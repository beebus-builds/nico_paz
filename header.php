...
<div id="page">
    <header id="site-navbar" data-navbar-position="top" class="navbar-wrapper navbar-top">
        ...
        <div class="navbar-bg-pattern" aria-hidden="true"></div>
        <div class="navbar-bg-grid" aria-hidden="true"></div>
        <div class="navbar-bg-sun" aria-hidden="true"></div>
        <div class="navbar-flag-accent" aria-hidden="true"></div>
        <div class="navbar-corner-shard" aria-hidden="true"></div>
        ...
        <div class="navbar-inner container-main">
            ...
            <div class="site-branding flex-shrink-0">
                <a href="<?php echo esc_url(home_url('/')); ?>" class="flex items-center gap-2 group" aria-label="<?php esc_attr_e('Home', 'nicopaz'); ?>">
                    <span class="navbar-crest-wrap">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/crest.svg'); ?>"
                             alt=""
                             class="navbar-crest h-9 w-auto">
                    </span>
                    <span class="navbar-brand-text font-jersey text-xl sm:text-2xl tracking-wide text-nico-dark dark:text-white">
            ...
            <!-- Actions -->
            <div class="navbar-actions flex items-center gap-1 sm:gap-2">

                <!-- Position picker -->
                <div class="navbar-position-picker relative hidden sm:block">
    ...
    <!-- Decorative Argentina flag accent (floating, fixed bottom-right) -->
