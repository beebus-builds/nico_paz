    ...
    <div class="container-main">
        ...
        <div class="space-y-3 mb-16">
            ...
            foreach ($fixtures as $f) : ?>
                <div class="flex flex-col md:flex-row items-center gap-4 p-5 rounded-xl bg-nico-gray-light dark:bg-gray-950 border border-gray-100 dark:border-gray-800 hover:border-celeste/30 dark:hover:border-celeste/30 transition-colors">
                    ...
                    <div class="flex-shrink-0 text-right">
                        <span class="px-3 py-1 rounded-full bg-celeste/10 dark:bg-white/10 text-celeste dark:text-white text-xs font-heading font-bold"><?php echo esc_html($f['comp']); ?></span>
        ...
        <div class="space-y-3">
            ...
            foreach ($results as $r) :
                $color = $r['result'] === 'W' ? 'text-green-600 dark:text-green-400' : ($r['result'] === 'D' ? 'text-yellow-600 dark:text-gold' : 'text-red-600 dark:text-red-400');
            ?>
